...
export async function searchWisata ({ commit }, key) {
  const response = await axios.get('http://localhost:8000/api/wisata/search?key=' + key)
...
export async function searchKafe ({ commit }, key) {
  const response = await axios.get('http://localhost:8000/api/kafe/search?key=' + key)
...
export async function searchWorkingSpace ({ commit }, key) {
  const response = await axios.get('http://localhost:8000/api/workingspace/search?key=' + key)
...
export async function searchKuliner ({ commit }, key) {
  const response = await axios.get('http://localhost:8000/api/kuliner/search?key=' + key)
...
export async function searchOlehOleh ({ commit }, key) {
  const response = await axios.get('http://localhost:8000/api/oleholeh/search?key=' + key)
